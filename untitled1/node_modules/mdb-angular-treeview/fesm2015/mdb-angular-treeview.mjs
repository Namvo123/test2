...
class MdbTreeviewComponent {
    ...
    _handleCheckboxClick(element, isChecked, node) {
        ...
        const toggleAllChildrenCheckboxes = (actualNode, state) => {
            ...
            (_a = actualNode[this.childrenField]) === null || _a === void 0 ? void 0 : _a.forEach((childrenNode) => {
    ...
    _deepFind(value, key = this.textField) {
        ...
        const findInNode = (nodes, value) => {
            nodes.forEach((node) => {
                var _a;
                const includes = (_a = node[key]) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(value.toLowerCase());
                if (includes) {
                    result = node;
                }
    ...
    _expandParentsNode(value, key = this.textField) {
        const findInNode = (nodes, value) => {
            nodes.forEach((parentNode) => {
                var _a;
                (_a = parentNode[this.childrenField]) === null || _a === void 0 ? void 0 : _a.forEach((childrenNode) => {
                    var _a;
                    const includes = (_a = childrenNode[key]) === null || _a === void 0 ? void 0 : _a.toLowerCase().includes(value.toLowerCase());
                    if (includes) {
