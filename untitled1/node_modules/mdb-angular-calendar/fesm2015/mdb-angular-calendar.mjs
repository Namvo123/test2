...
function mapEvents(events, startDate, endDate) {
    ...
    return events.map((event) => {
        ...
        return Object.assign(Object.assign({}, event), { startData: startData, endData: endData, eventStart: eventStartDate >= startDate, eventEnd: event.endDate <= endDate, oneDay: startData.date == endData.date &&
                eventEndDate.getTime() - eventStartDate.getTime() < MS_IN_DAY, allDay: eventEndDate.getTime() - eventStartDate.getTime() - eventDuration * MS_IN_DAY ==
                MS_IN_DAY - 1, longEvent: eventEndDate.getTime() - eventStartDate.getTime() >= MS_IN_DAY });
    });
}
...
class MdbCalendarEventModalComponent {
    ...
    parseEventData() {
        ...
        return Object.assign(Object.assign({}, event), { summary,
            description,
            allDay, color: {
...
class MdbCalendarMonthViewComponent {
    ...
    onEventDragEnd(calendarEvent) {
        ...
        const newEvent = Object.assign(Object.assign({}, calendarEvent), { startDate: newStartDate, endDate: newEndDate, order: '' });
