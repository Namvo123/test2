...
function addMdbModulesImports(options) {
    return (tree) => __awaiter(this, void 0, void 0, function* () {
        const workspace = yield (0, workspace_1.getWorkspace)(tree);
        const project = (0, schematics_2.getProjectFromWorkspace)(workspace, options.project);
        const module = { name: 'MdbDragAndDropModule', path: 'mdb-angular-drag-and-drop' };
...
function addStylesImports(options) {
    return (host, context) => __awaiter(this, void 0, void 0, function* () {
        ...
        const newContent = `@import '~mdb-angular-drag-and-drop/scss/drag-and-drop.scss';\n`;
...
//# sourceMappingURL=drag-and-drop-setup.js.map